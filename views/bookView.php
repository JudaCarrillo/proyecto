    ...
    <div class="container-fluid">
        ...
        <div class="main">
            ...
            <div class="informacion">
                ...
                <button type="button" name="btnRegistrar" class="button-80 z-3 position-relative mb-3 my-2" data-bs-toggle="modal" data-bs-target="#registroModal" data-bs-whatever="@mdo">Agregar Libro</button>
            </div>
